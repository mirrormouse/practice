...
vector<vector<long>> A(N+1,vector<long>(3));
A.at(0).at(0)=a.at(0);
A.at(0).at(1)=b.at(0);
A.at(0).at(2)=c.at(0);
for(long i=1;i<N+1;i++){
    A.at(i).at(0)=Max2(A.at(i-1).at(1),A.at(i-1).at(2))+a.at(i)
    A.at(i).at(1)=Max2(A.at(i-1).at(2),A.at(i-1).at(0))+b.at(i)
    A.at(i).at(2)=Max2(A.at(i-1).at(0),A.at(i-1).at(1))+c.at(i)
}
cout<<Max3(A.at(N).at(0),A.at(N).at(1),A.at(N).at(2))<<endl;
